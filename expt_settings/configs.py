...
import data_formatters.tro
import data_formatters.trafo
...
class ExperimentConfig(object):
  ...
  default_experiments = ['volatility', 'electricity', 'traffic', 'favorita', 'tro', 'trafo']
  ...
  def make_data_formatter(self):
    ...
    data_formatter_class = {
        ...
        'tro': data_formatters.tro.TroFormatter,
        'trafo': data_formatters.trafo.TrafoFormatter
    }
